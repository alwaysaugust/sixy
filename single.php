...
<?php get_header(); ?>
<div class="post-bc-bar"><div class="post-printer"><img src="/wp-content/uploads/sites/49/2022/03/icon_printer.png" /><a href="#" title="Print Page" onclick="window.print();return false;">Print</a></div></div>
<section id="content" <?php Avada()->layout->add_style( 'content_style' ); ?>>
	...
	<?php if ( fusion_get_option( 'blog_pn_nav' ) ) : ?>
		<div class="single-navigation clearfix">
			<?php previous_post_link( '%link', esc_attr__( 'Previous Post', 'Avada' ) ); ?>
			<?php next_post_link( '%link', esc_attr__( 'Next Post', 'Avada' ) ); ?>
	   </div>
	<?php endif; ?>
</section>
