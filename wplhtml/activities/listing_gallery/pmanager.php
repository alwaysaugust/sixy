    ...
    if(!count($gallery))
    {
        echo '
            <div class="no_image_box" style="width:'.$this->image_width.'px;height:'.$this->image_height.'px;">
                ...
                <span>'.__('No Image', 'real-estate-listing-realtyna-wpl').'</span>
            </div>';
    }
	else
    {
        ...
        echo '<img '.$this->itemprop_image.' id="wpl_gallery_image'.$this->property_id.'" src="'.$image_url.'" alt="'.$image_alt.'" class="wpl_gallery_image '.$this->image_class.'" width="'.$this->image_width.'" height="'.$this->image_height.'" style="width: '.$this->image_width.'px; height: '.$this->image_height.'px;" />';
	}
