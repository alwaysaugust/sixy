...
<div class="wpl_gallery_container" id="wpl_gallery_container<?php echo $this->property_id; ?>" style="max-height: <?php echo $this->image_height; ?>px;width: <?php echo $this->image_width; ?>px">
    ...
    else
    {
        ...
        foreach($this->gallery as $image)
        {
            ...
            {
      // echo count($this->gallery);
      
      echo '
      <li><img src="' . $this->gallery[$i]['url'] . '" ' . $this->itemprop_image . ' class="wpl_gallery_image ' . $this->image_class . '" id="wpl_gallery_image' . $image['raw']['id'] . '" width="' . $this->image_width . '" height="' . $this->image_height . '" alt="' . $image_alt . '" style="max-height:' . $this->image_height . 'px" /></li>';
