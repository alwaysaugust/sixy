...
$adding_price_request = (isset($params['adding_price_request']) and $params['adding_price_request']) ? 1 : 0;
...
<div class="wpl_listing_links_container" id="wpl_listing_links_container<?php echo $property_id; ?>">
	<ul>
        ...
        <li class="request_a_visit_link">
            <a class="wpl-tooltip-top" data-realtyna-lightbox data-realtyna-lightbox-opts="title:<?php echo __('Book a showing', 'real-estate-listing-realtyna-wpl'); ?>" href="<?php echo $this->lightbox_container; ?>" onclick="return wpl_request_a_visit_get_form(<?php echo $property_id; ?>);" title="<?php echo __('Book a showing', 'real-estate-listing-realtyna-wpl'); ?>"></a>
            <div class="wpl-util-hidden"><?php echo __('Book a showing', 'real-estate-listing-realtyna-wpl'); ?></div>
        </li>
        <?php endif; ?>

        <?php if(wpl_global::check_addon('save_searches') and $watch_changes): ?>
        <li class="watch_changes_link">
            <a class="wpl-tooltip-top" data-realtyna-lightbox data-realtyna-lightbox-opts="title:<?php echo __('Watch for changes', 'real-estate-listing-realtyna-wpl'); ?>" href="<?php echo $this->lightbox_container; ?>" onclick="return wpl_watch_changes_get_form(<?php echo $property_id; ?>);" title="<?php echo __('Watch changes on this property', 'real-estate-listing-realtyna-wpl'); ?>"></a>
            <div class="wpl-util-hidden"><?php echo __('Watch for changes', 'real-estate-listing-realtyna-wpl'); ?></div>
        </li>
        <?php endif; ?>
        ...
        <?php if($adding_price_request and $wpl_properties['current']['raw']['price'] == 0): ?>
            <li class="adding_price_request_link">
                <a class="wpl-tooltip-top" data-realtyna-lightbox data-realtyna-lightbox-opts="title:<?php echo __('Request the Price', 'real-estate-listing-realtyna-wpl'); ?>" href="<?php echo $this->lightbox_container; ?>" onclick="return wpl_adding_price_request(<?php echo $property_id; ?>);" title="<?php echo __('Request the Price', 'real-estate-listing-realtyna-wpl'); ?>"></a>
                <div class="wpl-util-hidden"><?php echo __('Request the Price', 'real-estate-listing-realtyna-wpl'); ?></div>
            </li>
        <?php endif; ?>
	</ul>
	
    <?php /** Favorite Login / Register Popup **/ ?>
    <a id="wpl_favorites_lightbox" class="wpl-util-hidden" data-realtyna-href="#wpl_pshow_lightbox_content_container" data-realtyna-lightbox-opts="title:<?php echo __('Login to continue', 'real-estate-listing-realtyna-wpl'); ?>"></a>
</div>