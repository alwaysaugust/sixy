    ...
    <div class="sidebar-wp">
        ...
        <div class="wpl-side-2 side-tabs-wp">
            <ul>
                ...
                <?php if(in_array($this->kind, $this->dbcat_manager_kinds)): ?>
                    <li><a data-id="0" href="#13" class="wpl_slide_label wpl_slide_label_prefix_m" id="wpl_slide_label_id13" onclick="rta.internal.slides.open('13', '.side-tabs-wp', '.wpl_slide_container', 'currentTab');"><?php echo 'Test Category'; ?></a></li>
                <?php endif; ?>
            </ul>
        </div>
