...
if(wpl_global::check_addon('brokerage'))
{
    ...
    $brokers = wpl_addon_brokerage::brokers();
}
...
<div class="wrap wpl-wp user-wp">
    ...
    <div class="wpl-users-search-form">
        <form method="GET" id="wpl_users_search_form">
            ...
            <select name="show_all" id="show_all" data-has-chosen="" title="<?php esc_attr_e('WPL / WordPress Users', 'real-estate-listing-realtyna-wpl'); ?>">
            ...
            <select name="membership_id" id="membership_id" data-has-chosen="" title="<?php esc_attr_e('Membership', 'real-estate-listing-realtyna-wpl'); ?>">
            ...
            <select name="parent" id="parent" data-has-chosen="" title="<?php esc_attr_e('Brokerage', 'real-estate-listing-realtyna-wpl'); ?>">
                <option value=""><?php echo __('Brokerage', 'real-estate-listing-realtyna-wpl'); ?></option>
                <?php foreach($brokers as $broker): ?>
                <option value="<?php echo $broker->id; ?>" <?php if($broker->id == $this->parent) echo 'selected="selected"'; ?>><?php echo trim($broker->first_name.' '.$broker->last_name).' ('.$broker->user_email.')'; ?></option>
                <?php endforeach; ?>
            </select>
            <?php endif; ?>
    ...
    <div class="sidebar-wp">
        ...
        <table class="widefat page">
            <thead>
                <tr>
                    <th scope="col" class="manage-column"><?php wpl_global::order_table(__('ID', 'real-estate-listing-realtyna-wpl'), 'u.id'); ?></th>
                    ...
                    <?php if(wpl_global::check_addon('brokerage')): ?><th scope="col" class="manage-column"><?php echo __('Brokerage', 'real-estate-listing-realtyna-wpl'); ?></th><?php endif; ?>
                    <th scope="col" class="manage-column"><?php echo __('Email', 'real-estate-listing-realtyna-wpl'); ?></th>
                    <th scope="col" class="manage-column"><?php wpl_global::order_table(__('Registered', 'real-estate-listing-realtyna-wpl'), 'u.user_registered'); ?></th>
                    <?php if(wpl_global::check_addon('membership')): ?><th scope="col" class="manage-column"><?php wpl_global::order_table(__('Expiry Date', 'real-estate-listing-realtyna-wpl'), 'wpl.expiry_date'); ?></th><?php endif; ?>
            ...
            <tbody>
                ...
                <tr id="item_row<?php echo $wp_user->ID; ?>">
                    ...
                    <td>
                        ...
                        <select data-without-chosen name="parent_<?php echo $wp_user->ID; ?>" id="parent_<?php echo $wp_user->ID; ?>" onChange="wpl_change_brokerage(<?php echo $wp_user->ID; ?>);" autocomplete="off" title="<?php esc_attr_e('Brokerage', 'real-estate-listing-realtyna-wpl') ?>">
                            <option value=""><?php echo __('None', 'real-estate-listing-realtyna-wpl'); ?></option>
                            <?php foreach($brokers as $broker): ?>
                                <option value="<?php echo $broker->id; ?>" <?php if(is_object($wpl_data) and $broker->id == $wpl_data->parent) echo 'selected="selected"'; ?>><?php echo $broker->user_login; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <span id="wpl_ajax_loader_parent_<?php echo $wp_user->ID; ?>"></span>
                        <?php endif; ?>
                    </td>
                    <?php endif; ?>
