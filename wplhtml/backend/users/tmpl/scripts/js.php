...
function wpl_ajax_save_users(key, element, id)
{
	...
	var url = '<?php echo wpl_global::get_full_url(); ?>';
	
	wpl_remove_message('.wpl_show_message'+id);
	wplj(ajax_loader_element).html('<img src="<?php echo wpl_global::get_wpl_asset_url('img/ajax-loader3.gif'); ?>" />');
	
    /** run ajax query **/
    var request_str = 'wpl_format=b:users:ajax&wpl_function=save&item_id=' + id + '&table_column=' + key + '&value=' + element.value + '&_wpnonce=<?php echo $this->nonce; ?>';
...
function wpl_change_membership(id)
{
	...
	var request_str = 'wpl_format=b:users:ajax&wpl_function=change_membership&id='+id+'&membership_id='+membership_id+'&_wpnonce=<?php echo $this->nonce; ?>';
...
function wpl_change_brokerage(id)
{
    wpl_remove_message('.wpl_user_list .wpl_show_message');

    ajax_loader_element = '#wpl_ajax_loader_parent_'+id;
    wplj(ajax_loader_element).html('<img src="<?php echo wpl_global::get_wpl_asset_url('img/ajax-loader3.gif'); ?>" />');

    var parent = wplj("#parent_"+ id).val();
    var request_str = 'wpl_format=b:users:ajax&wpl_function=change_parent&id='+id+'&parent='+parent+'&_wpnonce=<?php echo $this->nonce; ?>';
