...
<div class="wpl-links-send-to-friend-wp" id="wpl_form_send_to_friend_container">
    <form class="wpl-gen-form-wp" id="wpl_send_to_friend_form" onsubmit="wpl_send_to_friend_submit(); return false;" novalidate="novalidate">
        <div class="wpl-gen-form-row"><span class="property_form_labels_abs">Name</span>
        ...
        <span class="property_form_labels_abs">Email Address</span>
        ...
        <div class="wpl-gen-form-row">
        <span class="property_form_labels_abs">Friend Email Address</span>
        ...
        <span class="property_form_labels_abs">Email Subject</span>
        ...
        <div class="wpl-gen-form-row">
        <span class="property_form_labels_abs">Message</span>
