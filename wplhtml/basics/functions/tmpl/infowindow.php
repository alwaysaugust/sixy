	...
	<div id="main_infowindow">
		...
		<?php
            if(isset($property['items']['gallery']))
			{
                ...
                echo '<a href="'.$property['property_link'].'"><img itemprop="image" id="wpl_gallery_image'.$property_id .'_'.$i.'" src="'.$image_url.'" class="wpl_gallery_image" width="'.$image_width.'" height="'.$image_height.'" style="width: '.$image_width.'px; height: '.$image_height.'px;" alt="'.$image_alt.'" /></a>';
                $i++;
			}
			else
			{
