...
class wpl_users
{
	...
	public static function get_wpl_user($user_id = NULL)
	{
		...
		$query = "SELECT * FROM `{$wpdb->base_prefix}wpl_users` WHERE `id`='$user_id'";
    ...
    {
        return wpl_db::q("UPDATE `#__wpl_users` SET `parent`='".$parent."' WHERE `id`='".$user_id."'");
    }
}