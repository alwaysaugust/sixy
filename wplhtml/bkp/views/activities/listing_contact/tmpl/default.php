...
<div class="wpl_contact_container wpl-contact-listing-wp" id="wpl_contact_container<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>">
	...
	<form method="post" action="#" id="wpl_contact_form<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>" onsubmit="return wpl_send_contact<?php echo $this->activity_id; ?>(<?php echo $this->property_id; ?>);">
        ...
        <label>Full Name</label><br>
            <input class="text-box" type="text" id="wpl_contact_fullname<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>" name="fullname" placeholder="<?php echo __('Your full name', 'real-estate-listing-realtyna-wpl'); ?>" />
        </div>

        <div class="form-field">
        <label>Phone Number</label><br>
            <input class="text-box" type="text" id="wpl_contact_phone<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>" name="phone" placeholder="<?php echo __('Your phone number', 'real-estate-listing-realtyna-wpl'); ?>" />
        </div>

        <div class="form-field">
        <label>Email Address</label><br>
            <input class="text-box" type="text" id="wpl_contact_email<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>" name="email" placeholder="<?php echo __('Your email address', 'real-estate-listing-realtyna-wpl'); ?>" />
        </div>

        <div class="form-field wpl-contact-listing-msg">
        <label>Message</label><br>
            <textarea class="text-box" id="wpl_contact_message<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>" name="message" placeholder="<?php echo __('Your message', 'real-estate-listing-realtyna-wpl'); ?>"></textarea>
        </div>
        ...
        <div class="form-field wpl-contact-listing-btn">
            <input class="btn btn-primary" type="submit" value="<?php echo __('Book a showing', 'real-estate-listing-realtyna-wpl'); ?>" />
        </div>
    </form>
