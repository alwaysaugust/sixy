...
// Set default map_box in property_list
$this->property_css_class = !empty(wpl_request::getVar('wplpcc')) ? wpl_request::getVar('wplpcc') : 'map_box';
?>
...
<div class="wpl-row wpl-expanded <?php if($this->property_css_class == "grid_box") echo "wpl-small-up-1 wpl-medium-up-2 wpl-large-up-".$this->listing_columns; ?>  wpl_property_listing_listings_container clearfix">
    ...
    <p><?php _e('There are no listings around you matching criteria!', 'real-estate-listing-realtyna-wpl'); ?></p>
    <?php endif; ?>
