...
abstract class wpl_property_show_controller_abstract extends wpl_controller
{
	...
	public function display($instance = array())
	{
        ...
        // var_dump($current_user->maccess_lrestrict_pshow);
		if(($lrestrict and !in_array($property['listing'], $rlistings)) or ($ptrestrict and !in_array($property['property_type'], $rproperty_types)) or (isset($property['show_internet']) and $property['show_internet']!='' and $property['show_internet']== 0 ))
		{
			$this->message = __("You would need to login/register to view this property", 'real-estate-listing-realtyna-wpl');
