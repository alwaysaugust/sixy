    ...
    <form action="<?php echo wpl_property::get_property_listing_link(); ?>" id="wpl_search_form_<?php echo $widget_id; ?>" method="GET" onsubmit="return wpl_do_search_<?php echo $widget_id; ?>('wpl_searchwidget_<?php echo $widget_id; ?>');" class="wpl_search_from_box clearfix wpl_search_kind<?php echo $this->kind; ?> <?php echo $this->style.' '.$this->css_class; ?>">
        ...
        <div id="wpl_searchwidget_<?php echo $widget_id; ?>" class="clearfix">
            ...
            <div class="wpl_search_from_box_top">
                <?php echo $top_div; ?>
                <?php if($bott_div): ?>
                    <div class="more_search_option" data-widget-id="<?php echo $widget_id; ?>" id="more_search_option<?php echo $widget_id; ?>"><?php echo __('Advanced', 'real-estate-listing-realtyna-wpl'); ?></div>
                <?php endif; ?>
                ...
                <div class="search_submit_box">
                    <input id="wpl_search_widget_submit<?php echo $widget_id; ?>" class="wpl_search_widget_submit" onclick="return wpl_do_search_<?php echo $widget_id; ?>('wpl_searchwidget_<?php echo $widget_id; ?>');" type="button" value="<?php echo __('Search', 'real-estate-listing-realtyna-wpl'); ?>" />
