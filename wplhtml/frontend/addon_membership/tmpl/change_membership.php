...
<div class="wpl_addon_membership_container wpl_view_container wpl_membership_wrap" id="wpl_addon_membership_container">
    <div class="wpl_memberships_label"><?php echo __('Change memberships', 'real-estate-listing-realtyna-wpl'); ?></div>
            ...
            <li id="wpl_memberships<?php echo $membership->id; ?>" class="wpl_memberships <?php echo ($this->selected == $membership->id ? 'selected' : ''); ?>">
                <div class="wpl_memberships_wrap">
                    <h3 class="membership_headline" <?php echo (isset($membership->maccess_wpl_color) ? 'style="background:'.$membership->maccess_wpl_color.'"' : ''); ?>>
                        ...
                        <span class="membership_price"><?php echo $this->membership->render_price($membership->maccess_price, $membership->maccess_price_unit); ?></span>
                    </h3>
                ...
                <?php if($this->link_type == 'onclick'): ?>
                    <span class="membership_upgrade" <?php echo (isset($membership->maccess_wpl_color) ? 'style="background:'.$membership->maccess_wpl_color.'"' : ''); ?> onclick="wpl_upgrade_membership_transaction(<?php echo $membership->id; ?>, <?php echo $this->user_id; ?>);"><?php echo __('Upgrade', 'real-estate-listing-realtyna-wpl'); ?></span>
                <?php else: ?>
                    <a class="membership_upgrade_link" <?php echo (isset($membership->maccess_wpl_color) ? 'style="background:'.$membership->maccess_wpl_color.'"' : ''); ?> href="<?php echo $link; ?>"><?php echo __('Upgrade', 'real-estate-listing-realtyna-wpl'); ?></a>
                <?php endif; ?>
            </li>
        <?php } ?>
    </ul>
