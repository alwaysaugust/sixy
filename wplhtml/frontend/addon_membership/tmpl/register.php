...
<div class="wpl_addon_membership_container wpl_view_container wpl_membership_wrap" id="wpl_addon_membership_container">
    ...
    <div class="wpl_dashboard_registeration">
        <p id="wpl_register_info"><?php echo sprintf(__("You're registering as <strong>%s</strong> in <strong %s>%s</strong> membership.", 'real-estate-listing-realtyna-wpl'), $this->user_type_data->name, $membership_color, $this->membership_data->membership_name); ?></p>
