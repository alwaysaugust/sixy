...
<div class="fav-label-wrapper">
        <div class="fav-label">123
            <img src="/tosell/wp-content/uploads/sites/49/2022/05/icon_fav-label.png" />
            <h4>Added to Favourites</h4>
            <P>You can access your favourites under account feature</p>
        </div>
</div>
