...
var wpl_ajax = <?php echo (wpl_global::check_addon('aps') ? (empty(wpl_global::get_setting('aps_ajax_listing')) ? 0 : wpl_global::get_setting('aps_ajax_listing')) : 0); ?>;
...
function wpl_set_property_css_class(pcc)
{
    ...
    if((pcc == 'row_box' || pcc == 'grid_box') && typeof wpl_sp_selector_div != 'undefined')
    {
        ...
        wplj(wpl_sp_selector_div).off('click', wpl_scroll_pagination_listener); /*scroll*/

        wpl_sp_selector_div = window;
        wpl_sp_append_div = '#wpl_property_listing_container';

        /** Add new scroll listener **/
        var wpl_scroll_pagination_listener = wplj(wpl_sp_selector_div).on('click', function() /*scroll*/
        {
    ...
    {
        /** Remove previous scroll listener **/
        wplj(wpl_sp_selector_div).off('click', wpl_scroll_pagination_listener);

        wpl_sp_selector_div = '.wpl_property_listing_listings_container';
        wpl_sp_append_div = '.wpl_property_listing_listings_container';

        /** Add new scroll listener **/
        var wpl_scroll_pagination_listener = wplj(wpl_sp_selector_div).on('click', function()
        {
            wpl_scroll_pagination();
        });
    }
...
var wpl_favorites_force_login = <?php echo ((!wpl_users::get_cur_user_id() and wpl_global::check_addon('membership') and wpl_global::get_setting('favorite_force_login') == '1') ? 1 : 0); ?>;
function wpl_favorite_control(id, mode)
{
    ...
    /*function addfav(){
         ////////////////////////////////////////////////////////
	    wplj(".fav-label-wrapper").delay(500).fadeIn( "slow" );
        wplj(".fav-label-wrapper").delay(3500).fadeOut( "slow" );
    }*/
    
    var request_str = 'wpl_format=f:property_listing:ajax_pro&wpl_function=favorites_control&pid='+id+'&mode='+mode;
    var ajax = wpl_run_ajax_query('<?php echo wpl_global::get_wp_url(); ?>', request_str, false, 'JSON', 'GET');

    var loader = Realtyna.ajaxLoader.show(wplj('#wpl_favorite_add_'+id).parent('li'), 'tiny', 'center', true, 'transparent', 3, {
    ...
    ajax.success(function(data)
    {
        ...
        var fl = wplj('#wpl_favorite_remove_'+id).parent('li').attr('class');
        //alert (fl);

        wplj('#wpl_favorite_add_'+id).toggle();
        Realtyna.ajaxLoader.hide(loader);
        
        if (fl=="favorite_link added"){
            wplj(".fav-label-wrapper").delay(200).fadeIn( "slow" );
            wplj(".fav-label-wrapper").delay(3500).fadeOut( "slow" );
            //wplj('#wpl_favorite_add_'+id).toggle();
        }
