    ...
    <div class="wpl_prp_container" id="wpl_prp_container<?php echo $this->pid; ?>" <?php echo $this->itemscope.' '.$this->itemtype_ApartmentComplex; ?>>
        ...
        <div class="wpl_prp_container_content">
            <div class="wpl-row wpl-expanded wpl_prp_container_content_title">
                ...
                echo '<h2 class="location_build_up" '.$this->itemprop_address.' '.$this->itemscope.' '.$this->itemtype_PostalAddress.'>'.(trim($build_up_area) ? $build_up_area.' - ' : '').'<span '.$this->itemprop_addressLocality.'>'. $location_string .'</span></h2>';
                    ...
                    <div class="wpl_prp_right_boxes_content">
                        <div class="wpl_prp_right_boxe_details_top clearfix">
                            <div class="wpl_prp_right_boxe_details_left">
                                <ul>
                                    <?php if(trim($listing_id) != ''): ?><li><?php echo __($this->wpl_properties['current']['materials']['mls_id']['name'], 'real-estate-listing-realtyna-wpl').' : <span class="value">'.$listing_id.'</span>'; ?></li><?php endif; ?>
                                    <?php if(trim($bedroom) != ''): ?><li><?php echo __($this->wpl_properties['current']['materials']['bedrooms']['name'], 'real-estate-listing-realtyna-wpl').' : <span class="value">'.$bedroom.'</span>'; ?></li><?php endif; ?>
                                    <?php if(trim($bathroom) != ''): ?><li><?php echo __($this->wpl_properties['current']['materials']['bathrooms']['name'], 'real-estate-listing-realtyna-wpl').' : <span class="value">'.$bathroom.'</span>'; ?></li><?php endif; ?>
                                    <?php if(trim($build_up_area) != ''): ?><li><?php echo __($build_up_area_name, 'real-estate-listing-realtyna-wpl').' : <span class="value">'.$build_up_area.'</span>'; ?></li><?php endif; ?>
                                    <?php if($price_type): ?><li><?php echo __($this->wpl_properties['current']['materials']['price_period']['name'], 'real-estate-listing-realtyna-wpl').' : <span class="value">'.$price_type.'</span>'; ?></li><?php endif; ?>
                                </ul>
                            </div>
