...
echo wpl_global::include_google_maps();
...
function wpl_initialize<?php echo $this->activity_id; ?>()
{
    ...
    var styles = [{"featureType": "water", "stylers": [{"color": "#b0d3e3"},{"visibility": "on"}]},{"featureType": "landscape","stylers": [{"color": "#f2f2f2"}]},{"featureType": "road","stylers": [{"saturation": -100},{"lightness": 45}]},{"featureType": "road.highway","stylers": [{"visibility": "simplified"}]},{"featureType": "administrative","elementType": "labels.text.fill","stylers": [{"color": "#444444"}]},{"featureType": "poi","stylers": [{"visibility": "off"}]}];
...
function wpl_marker<?php echo $this->activity_id; ?>(dataMarker)
{
    ...
    var marker_content = '<img src="<?php echo wpl_global::get_wpl_url(); ?>assets/img/listing_types/gicon/'+dataMarker.gmap_icon+'" alt="map marker">';
	...
	else
	{
        ...
        if(typeof wpl_marker_cluster<?php echo $this->activity_id; ?> == 'undefined')
        {
            ...
            (
				...
				{styles:[{
					url: '<?php echo wpl_global::get_wpl_url(); ?>assets/packages/markerclusterer/img/<?php echo $this->clusterer_iconset; ?>ts1.png',
					width: 53,
					height: 52,
					textSize:15,
					textColor:"white"
				...
				{
					url: '<?php echo wpl_global::get_wpl_url(); ?>assets/packages/markerclusterer/img/<?php echo $this->clusterer_iconset; ?>ts2.png',
					width: 56,
					height:55,
					textSize:15,
					textColor:"white"
				...
				{
					url: '<?php echo wpl_global::get_wpl_url(); ?>assets/packages/markerclusterer/img/<?php echo $this->clusterer_iconset; ?>ts3.png',
					width: 66,
					height:65,
					textSize:15,
					textColor:"white"
				...
				{
					url: '<?php echo wpl_global::get_wpl_url(); ?>assets/packages/markerclusterer/img/<?php echo $this->clusterer_iconset; ?>ts4.png',
					width: 78,
					height: 77,
					textSize:15,
					textColor:"white"
				...
				{
					url: '<?php echo wpl_global::get_wpl_url(); ?>assets/packages/markerclusterer/img/<?php echo $this->clusterer_iconset; ?>ts5.png',
					width: 90,
					height:89,
					textSize:15,
					textColor:"white"
