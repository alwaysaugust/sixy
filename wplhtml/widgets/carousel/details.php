...
$image_width = isset($this->instance['data']['image_width']) ? $this->instance['data']['image_width'] : 400;
                        ...
                        <div class="right_section">
                         '.(isset($gallery['materials']['price']) ? '<div class="price" content="'.$gallery['materials']['price']['value'].'">'.$gallery['materials']['price']['value'].'</div>
                           <div class="title" '.$this->itemprop_name.'><a class="more_info_title" href="'.$gallery["property_link"].'">'.$image_title.'</a></div>
                            <!--<div class="location" '.$this->itemprop_address.'>'.($location_visibility === true ? $gallery["location_text"] : $location_visibility).'</div><div class="description" '.$this->itemprop_description.'>'.substr($description, 0, $cut_position + 1).'</div>-->' : '').'
                            <div class="owl-item-prp_bottom">
                            <div class="wpl_icon_box_wrap">
                                <div class="wpl_icon_box">
                                    '.(isset($gallery['materials']['bedrooms']) ? '<div class="bedrooms" content="'.$gallery['materials']['bedrooms']['value'].'">'.$gallery['materials']['bedrooms']['value'].' <span class="feature_bed">Bed</span></div>' : '').'
                                    '.(isset($gallery['materials']['bathrooms']) ? '<div class="bathrooms" content="'.$gallery['materials']['bathrooms']['value'].'">'.$gallery['materials']['bathrooms']['value'].' <span class="feature_bath">Bath</span></div>' : '').'
