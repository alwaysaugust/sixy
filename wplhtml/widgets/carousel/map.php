...
/** import js codes **/
$this->_wpl_import('widgets.carousel.scripts.js_map', true, true);
?>
<div class="wpl_googlemap_carousel wpl_googlemap_container <?php echo $this->css_class; ?>" id="wpl_googlemap_container<?php echo $this->widget_id; ?>">
