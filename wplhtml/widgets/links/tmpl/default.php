...
<div class="wpl_links_widget_container <?php echo $this->css_class; ?>">
    <?php
        ...
        if(!is_user_logged_in())
        {
            ...
            if($this->forget_password_link) $loginstr .= '<li><a href="'.wp_lostpassword_url().'"><i class="'.$forgeticon.'" aria-hidden="true"></i> '.__('Forgot Password', 'real-estate-listing-realtyna-wpl').'</a></li>';
        ...
        else
        {
            ...
            if(wpl_global::check_addon('save_searches') and $this->save_search_link) $loginstr .= '<li><a href="'.$this->save_search_url.'"><i class="'.$savesearchicon.'" aria-hidden="true"></i> '.__('Saved Searches', 'real-estate-listing-realtyna-wpl').'</a></li>';
