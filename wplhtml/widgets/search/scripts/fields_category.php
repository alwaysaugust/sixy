...
<div id="wpl-search-tab-content-<?php echo $this->widget_id . '-' . $category->id; ?>" class="search-body">
    <div class="search-msg-wp">
        <span>
        <?php echo __('Drag whichever field you would like to move from the bottom list to here. To change the order please use right side panel "Fields Order".', 'real-estate-listing-realtyna-wpl'); ?>
        </span>
    ...
    <div class="overlay-wp">
        <div class="overlay-text">
            <?php echo __('Drag Here', 'real-estate-listing-realtyna-wpl'); ?>
        </div>
    </div>
</div>
