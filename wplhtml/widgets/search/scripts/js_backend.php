    ...
    wplj('#btn-search-<?php echo $this->number ?>').off('click').on('click',function(evn){
        ...
        wplj._realtyna.lightbox.open(wplj(this), {
            ...
            callbacks: {
                ...
                afterClose : function(){
                    wplj("#<?php echo $this->get_field_id('css_class'); ?>").trigger('change');
                }
            }
        });
...
var wplSearchWidget<?php echo $this->number ?> = (function ($) {
    ...
    W.addDroppableOverlays = function(){
        var dragOverlayTmpl = '<div class="overlay-wp"><div class="overlay-text"><?php echo __('Drag Here', 'real-estate-listing-realtyna-wpl'); ?></div></div>';
